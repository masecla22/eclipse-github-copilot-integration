...
public class TelemetryData {
	...
	public static TelemetryData extend(TelemetryData data, Map<String, String> properties,
			Object2DoubleMap<String> metrics) {
	...
	public String toString() {
		return "TelemetryData(wrapped=" + this.getWrapped() + ", properties=" + this.getProperties() + ", metrics="
				+ this.getMetrics() + ", issuedTimestamp=" + this.getIssuedTimestamp() + ", displayedTimestamp="
				+ this.getDisplayedTimestamp() + ")";
	}

	private TelemetryData(TelemetryData wrapped, Map<String, String> properties, Object2DoubleMap<String> metrics,
			long issuedTimestamp, long l) {
