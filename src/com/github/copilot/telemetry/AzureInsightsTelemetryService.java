...
public class AzureInsightsTelemetryService implements TelemetryService, Disposable {
	...
	private final TelemetryClient client = AzureInsightsTelemetryService
			.setupClient("7d7048df-6dd0-4048-bb23-b716c1461f8f");
	private final TelemetryClient clientSecure = AzureInsightsTelemetryService
			.setupClient("3fdd7f28-937a-48c8-9a21-ba337db23bd1");
	...
	private void doTrack(TelemetryClient client, String name, Map<String, String> properties,
		...
		client.trackEvent((String) prefixedName, AzureInsightsTelemetryService.sanitizeMap(properties),
				AzureInsightsTelemetryService.sanitizeMap(metrics));
	}
