...
public final class OpenAICompletionResponse {
	...
	public String toString() {
		return "OpenAICompletionResponse(id=" + this.getId() + ", createdTimestamp=" + this.getCreatedTimestamp()
				+ ", model=" + this.getModel() + ", choices=" + Arrays.deepToString(this.getChoices()) + ")";
	}
	...
	public static final class Logprobs {
		...
		public boolean equals(Object o) {
			...
			return !(this$topLogprobs == null ? other$topLogprobs != null
		...
		public String toString() {
			return "OpenAICompletionResponse.Logprobs(tokens=" + Arrays.deepToString(this.getTokens()) + ", textOffset="
					+ Arrays.toString(this.getTextOffset()) + ", tokenLogprobs="
					+ Arrays.toString(this.getTokenLogprobs()) + ", topLogprobs=" + this.getTopLogprobs() + ")";
		}
	}
	...
	public static final class Choice {
		...
		public boolean equals(Object o) {
			...
			return !(this$finishReason == null ? other$finishReason != null
					: !this$finishReason.equals(other$finishReason));
		}
		...
		public String toString() {
			return "OpenAICompletionResponse.Choice(text=" + this.getText() + ", index=" + this.getIndex()
					+ ", logprobs=" + this.getLogprobs() + ", finishReason=" + this.getFinishReason() + ")";
		}
	}
}
