...
public final class DefaultAPIChoice implements APIChoice {
	...
	public boolean equals(Object o) {
		...
		if (this$meanLogProb == null ? other$meanLogProb != null
				: !((Object) this$meanLogProb).equals(other$meanLogProb)) {
			return false;
		}
		...
		if (this$responseInfo == null ? other$responseInfo != null
				: !((Object) this$responseInfo).equals(other$responseInfo)) {
			return false;
		}
		...
		if (this$baseTelemetryData == null ? other$baseTelemetryData != null
				: !((Object) this$baseTelemetryData).equals(other$baseTelemetryData)) {
			return false;
		}
		TelemetryData this$telemetryData = this.getTelemetryData();
		TelemetryData other$telemetryData = other.getTelemetryData();
		return !(this$telemetryData == null ? other$telemetryData != null
				: !((Object) this$telemetryData).equals(other$telemetryData));
	}
	...
	public String toString() {
		return "DefaultAPIChoice(responseInfo=" + this.getResponseInfo() + ", completion=" + this.getCompletion()
				+ ", numTokens=" + this.getNumTokens() + ", choiceIndex=" + this.getChoiceIndex() + ", requestID="
				+ this.getRequestID() + ", completionId=" + this.getCompletionId() + ", createdTimestamp="
				+ this.getCreatedTimestamp() + ", meanLogProb=" + this.getMeanLogProb() + ", baseTelemetryData="
				+ this.getBaseTelemetryData() + ", isCached=" + this.isCached() + ", telemetryData="
				+ this.getTelemetryData() + ")";
	}

	public DefaultAPIChoice(CompletionResponseInfo responseInfo, List<String> completion, int numTokens,
			int choiceIndex, int requestID, String completionId, int createdTimestamp, Double meanLogProb,
			TelemetryData baseTelemetryData, boolean isCached) {
	...
	public DefaultAPIChoice(CompletionResponseInfo responseInfo, List<String> completion, int numTokens,
			int choiceIndex, int requestID, String completionId, int createdTimestamp, Double meanLogProb,
			TelemetryData baseTelemetryData, boolean isCached, TelemetryData telemetryData) {
		if (responseInfo == null) {
			throw new IllegalStateException("responseInfo cannot be null!");
		}
		if (completion == null) {
	...
	public DefaultAPIChoice withCompletion(List<String> completion) {
		...
		return this.completion == completion ? this
				: new DefaultAPIChoice(this.responseInfo, completion, this.numTokens, this.choiceIndex, this.requestID,
						this.completionId, this.createdTimestamp, this.meanLogProb, this.baseTelemetryData,
						this.isCached, this.telemetryData);
	}
	...
	private DefaultAPIChoice withCached(boolean isCached) {
		return this.isCached == isCached ? this
				: new DefaultAPIChoice(this.responseInfo, this.completion, this.numTokens, this.choiceIndex,
						this.requestID, this.completionId, this.createdTimestamp, this.meanLogProb,
						this.baseTelemetryData, isCached, this.telemetryData);
	}
}
