...
public interface OpenAIService {
	public static OpenAIService getInstance() {
		OpenAIService openAIService = (OpenAIService) ApplicationManager.getApplication()
	...
	public void fetchCompletions(String var1, LanguageEditorRequest var2, String var3, int var4, double var5, int var7,
			int var8, BlockMode var9, boolean var10, TelemetryData var11, Flow.Subscriber<APIChoice> var12);
