...
public final class CompletionResponseInfo {
    ...
    public Map<String, String> createTelemetryData() {
        return Map.of("headerRequestId", this.headerRequestId, "serverExperiments", this.serverExperiments, "proxyRole", this.proxyRole, "modelEndpoint", this.modelEndpoint);
    }

    public CompletionResponseInfo(String headerRequestId, String serverExperiments, String proxyRole, String modelEndpoint, long requestStartTimestamp, long processingTimeMillis) {
    ...
    public boolean equals(Object o) {
        ...
        if (this$headerRequestId == null ? other$headerRequestId != null : !this$headerRequestId.equals(other$headerRequestId)) {
            return false;
        }
        String this$serverExperiments = this.getServerExperiments();
        String other$serverExperiments = other.getServerExperiments();
        if (this$serverExperiments == null ? other$serverExperiments != null : !this$serverExperiments.equals(other$serverExperiments)) {
            return false;
        }
        ...
        return !(this$modelEndpoint == null ? other$modelEndpoint != null : !this$modelEndpoint.equals(other$modelEndpoint));
    }
    ...
    public String toString() {
        return "CompletionResponseInfo(headerRequestId=" + this.getHeaderRequestId() + ", serverExperiments=" + this.getServerExperiments() + ", proxyRole=" + this.getProxyRole() + ", modelEndpoint=" + this.getModelEndpoint() + ", requestStartTimestamp=" + this.getRequestStartTimestamp() + ", processingTimeMillis=" + this.getProcessingTimeMillis() + ")";
    }
}
