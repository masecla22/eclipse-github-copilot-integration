...
final class OpenAIBodyHandler implements HttpResponse.BodyHandler<Object> {
	...
	public HttpResponse.BodySubscriber<Object> apply(HttpResponse.ResponseInfo responseInfo) {
		...
		ServerSideEventProcessor jsonStreamProcessor = new ServerSideEventProcessor(this.editorRequest,
				this.jsonSubscriber);
		...
		HttpResponse.BodySubscriber<Object> bodySubscriber = HttpResponse.BodySubscribers
				.fromLineSubscriber(jsonStreamProcessor, subscriber -> {
