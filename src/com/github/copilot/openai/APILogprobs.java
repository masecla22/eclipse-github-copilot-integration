...
final class APILogprobs {
	...
	Map<String, String> createTelemetryJson() {
		...
		Map<String, String> map = Map.of("logprobs_text_offset",
				this.textOffset == null ? fallback : gson.toJson(this.textOffset), "logprobs_token_logprobs",
				this.tokenLogprobs == null ? fallback : gson.toJson(this.tokenLogprobs), "logprobs_top_logprobs",
				this.topLogprobs == null ? fallback : gson.toJson(this.topLogprobs), "logprobs_tokens",
				this.tokens == null ? fallback : gson.toJson(this.tokens));
		if (map == null) {
	...
	public APILogprobs(List<Integer> textOffset, List<Double> tokenLogprobs, List<StringDoublePair> topLogprobs,
			List<String> tokens) {
	...
	public boolean equals(Object o) {
		...
		if (this$tokenLogprobs == null ? other$tokenLogprobs != null
				: !((Object) this$tokenLogprobs).equals(other$tokenLogprobs)) {
			return false;
		}
		List<StringDoublePair> this$topLogprobs = this.getTopLogprobs();
		List<StringDoublePair> other$topLogprobs = other.getTopLogprobs();
		if (this$topLogprobs == null ? other$topLogprobs != null
				: !((Object) this$topLogprobs).equals(other$topLogprobs)) {
			return false;
		}
	...
	public String toString() {
		return "APILogprobs(textOffset=" + this.getTextOffset() + ", tokenLogprobs=" + this.getTokenLogprobs()
				+ ", topLogprobs=" + this.getTopLogprobs() + ", tokens=" + this.getTokens() + ")";
	}
