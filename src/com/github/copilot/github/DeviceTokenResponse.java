...
class DeviceTokenResponse {
    ...
    public String toString() {
        return "DeviceTokenResponse(accessToken=" + this.getAccessToken() + ", tokenType=" + this.getTokenType() + ", scope=" + this.getScope() + ", error=" + this.getError() + ", errorDescription=" + this.getErrorDescription() + ", errorURI=" + this.getErrorURI() + ", slowDownIntervalSeconds=" + this.getSlowDownIntervalSeconds() + ")";
    }
}
