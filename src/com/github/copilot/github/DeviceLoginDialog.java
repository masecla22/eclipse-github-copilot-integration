...
public class DeviceLoginDialog extends DialogWrapper {
	...
	protected Action[] createActions() {
		DialogWrapper.DialogWrapperAction proceedButton = new DialogWrapper.DialogWrapperAction(
				CopilotBundle.get("deviceAuth.okButton")) {
