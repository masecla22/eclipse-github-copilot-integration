...
public class DeviceCodeResponse {
	...
	public String toString() {
		return "DeviceCodeResponse(deviceCode=" + this.getDeviceCode() + ", userCode=" + this.getUserCode()
				+ ", verificationUri=" + this.getVerificationUri() + ", expiresIn=" + this.getExpiresIn()
	...
	public DeviceCodeResponse(String deviceCode, String userCode, String verificationUri, long expiresIn,
