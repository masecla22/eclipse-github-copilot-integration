...
class DeviceLoginForm {
	...
	private void createUIComponents() {
		...
		ExtendableTextComponent.Extension copy = ExtendableTextComponent.Extension
				.create((Icon) PlatformIcons.COPY_ICON, (String) CopilotBundle.get("deviceAuth.copyTooltip"), () -> {
	...
	private /* synthetic */ void $$$setupUI$$$() {
		...
		jPanel.setBorder(
				BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(2, 2, 2, 2), null, 0, 0, null, null));
		JBLabel jBLabel = this.descriptionLabel;
		jBLabel.setText("-placeholder-");
		jPanel.add((Component) jBLabel,
				new GridConstraints(0, 0, 1, 2, 0, 1, 3, 3, null, new Dimension(350, -1), null));
		Spacer spacer = new Spacer();
		jPanel.add((Component) spacer, new GridConstraints(4, 1, 1, 1, 0, 2, 5, 6, null, null, null));
		JBLabel jBLabel2 = new JBLabel();
		this.$$$loadLabelText$$$((JLabel) jBLabel2,
				ResourceBundle.getBundle("copilot/copilot").getString("deviceAuth.code.label"));
		jPanel.add((Component) jBLabel2,
				new GridConstraints(3, 0, 1, 1, 0, 1, 3, 3, null, new Dimension(161, 18), null));
		JBLabel jBLabel3 = new JBLabel();
		this.$$$loadLabelText$$$((JLabel) jBLabel3,
				ResourceBundle.getBundle("copilot/copilot").getString("deviceAuth.website.label"));
		...
		jPanel.add((Component) spacer2,
				new GridConstraints(1, 0, 1, 1, 0, 2, 1, 0, new Dimension(-1, 10), null, new Dimension(-1, 10)));
