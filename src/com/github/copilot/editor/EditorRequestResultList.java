...
class EditorRequestResultList {
	...
	public String toString() {
		return "EditorRequestResultList(request=" + this.getRequest() + ", inlayLists=" + this.getInlayLists()
				+ ", index=" + this.getIndex() + ", maxShownIndex=" + this.getMaxShownIndex()
				+ ", hasOnDemandCompletions=" + this.isHasOnDemandCompletions() + ")";
	}
