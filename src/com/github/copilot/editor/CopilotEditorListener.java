...
public class CopilotEditorListener implements EditorFactoryListener {
	private static final Set<String> REJECTED_COMMANDS = Set.of("Typing", "Backspace", "Choose Lookup Item",
	...
	public void editorCreated(EditorFactoryEvent event) {
		...
		editor.getDocument().addDocumentListener((DocumentListener) new CopilotDocumentListener(editor),
				editorDisposable);
	}
	...
	private static final class CopilotCaretListener implements CaretListener {
		...
		public void caretPositionChanged(CaretEvent event) {
			...
			if (CopilotApplicationSettings.settings().isShowIdeCompletions()
					&& LookupManager.getActiveLookup((Editor) this.editor) != null) {
