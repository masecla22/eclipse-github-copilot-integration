...
class CopilotDefaultInlayRenderer implements CopilotInlayRenderer {
	...
	public void paint(Inlay inlay, Graphics2D g, Rectangle2D region, TextAttributes textAttributes) {
		...
		InlayRendering.renderCodeBlock(editor, this.content, this.lines, g, region,
				CopilotDefaultInlayRenderer.getTextColor(editor, textAttributes));
	}
	...
	public String toString() {
		return "CopilotDefaultInlayRenderer(lines=" + this.getLines() + ", content=" + this.getContent() + ", type="
				+ this.getType() + ", cachedWidth=" + this.getCachedWidth() + ", cachedHeight=" + this.getCachedHeight()
				+ ")";
	}
