...
public class DelegatingCompletionService implements CopilotCompletionService {
	...
	public boolean fetchCompletions(EditorRequest request, GitHubCopilotToken proxyToken, Integer maxCompletions,
		...
		return this.getDelegate().fetchCompletions(request, proxyToken, maxCompletions, enableCaching, cycling,
				subscriber);
	}
