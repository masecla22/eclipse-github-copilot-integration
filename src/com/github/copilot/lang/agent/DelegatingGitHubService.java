...
public class DelegatingGitHubService implements GitHubService {
	...
	public GitHubCopilotToken fetchCopilotTokenInteractive(Project project, GitHubSession sessionOverride,
		...
		return this.getDelegate().fetchCopilotTokenInteractive(project, sessionOverride, storeToken, onUnauthorized,
				onNewTokenExpired);
	}
	...
	private GitHubService getDelegate() {
		GitHubService gitHubService = CopilotAgent.isAgentSupportedAndEnabled() ? this.agentService
				: this.defaultService;
