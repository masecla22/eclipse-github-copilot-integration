...
Disposable {
    ...
    private volatile boolean isCancelled;
        ...
        return new AgentEditorRequest(project, completionType, useTabs, tabWidth, RequestId.incrementAndGet(), file.getLanguage(), relativePath, document.getText(), offset, lineInfo, document instanceof DocumentEx ? Integer.valueOf(((DocumentEx)document).getModificationSequence()) : null);
    }
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int n) {
        ...
        switch (n) {
            ...
            case 2: {
                objectArray2 = objectArray3;
                objectArray3[0] = "com/github/copilot/lang/agent/AgentEditorRequest";
                break;
            }
            case 3: {
                objectArray2 = objectArray3;
        ...
        switch (n) {
            default: {
                ...
                objectArray2[1] = "com/github/copilot/lang/agent/AgentEditorRequest";
                break;
            }
            case 1: {
                objectArray = objectArray2;
