...
public class GetCompletionsResult {
	...
	public boolean equals(Object o) {
		...
		return !(this$completions == null ? other$completions != null
				: !((Object) this$completions).equals(other$completions));
	}
	...
	public static final class Completion {
		...
		public String toString() {
			return "GetCompletionsResult.Completion(uuid=" + this.getUuid() + ", text=" + this.getText() + ", range="
					+ this.getRange() + ", displayText=" + this.getDisplayText() + ", position=" + this.getPosition()
					+ ")";
		}
	}
}
