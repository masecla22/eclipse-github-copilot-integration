...
public class CopilotAgentProcessServiceImpl implements CopilotAgentProcessService, Disposable {
	...
	public CopilotAgentProcessServiceImpl() {
		...
		this.messageSender = process == null ? new NullCommandSender()
				: new VSCodeJsonRpcCommandSender(this.agentProcess.getProcessInput());
	}
				...
				this.addProcessListener((ProcessListener) new ProcessAdapter() {
					...
					public void onTextAvailable(ProcessEvent event, Key outputType) {
						...
						if (LOG.isTraceEnabled()) {
							LOG.trace(String.format("agent onTextAvailable: %s, outputType: %s", event.getText(),
									outputType));
						}
