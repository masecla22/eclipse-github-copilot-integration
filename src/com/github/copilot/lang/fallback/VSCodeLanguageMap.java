...
public final class VSCodeLanguageMap {
	public static final Map<String, String> INTELLIJ_VSCODE_MAP = Collections
			.unmodifiableMap(new ConcurrentHashMap<String, String>() {
	...
	public static final Map<String, String> SHEBANG_MAP = Collections
			.unmodifiableMap(new ConcurrentHashMap<String, String>() {
